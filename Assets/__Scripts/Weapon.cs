...
namespace Assets.__Scripts
{
    ...
    public class Weapon : MonoBehaviour
    {
        ...
        private void Fire()
        {
            ...
            switch (type)
            {
                case eWeaponType.blaster:
                    p = MakeProjectile();
                    p.vel = vel;
                    audioSource.PlayOneShot(blasterSound, volume);
                    break;
                ...
                case eWeaponType.missile:
                    p = MakeProjectile();
                    p.vel = vel;
                    audioSource.PlayOneShot(missileSound, 0.2f);
                    break;
            }
        }
        ...
        private ProjectileHero MakeProjectile()
        {
            ...
            p.type = type;
            nextShotTime = Time.time + def.delayBetweenShots - Main.S.shootingDelayUpgrade;
            return p;
        }
    }
}
